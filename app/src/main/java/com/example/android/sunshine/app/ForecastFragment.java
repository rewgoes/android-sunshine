...
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            new FeatchWeatherTask().execute("13486-171");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<String> weekForecast = new ArrayList<String>(Arrays.asList(listForecast));
    ...
    public class FeatchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        private final String TAG = FeatchWeatherTask.class.getSimpleName();
